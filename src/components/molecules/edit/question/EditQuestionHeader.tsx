...
import { selectIdToken, selectQuestions, setQuestions } from "../../../../slices/editSlice";
        ...
        .then(async (response) => {
          ...
          if (newQuestion) {
            ...
            dispatch(setQuestions(questions.map((quest) =>
              quest.quest_id === newQuestion.quest_id ? { ...quest, is_old: newQuestion.is_old || false, not_ready: newQuestion.not_ready || false } : quest
            )))
          }
        })
