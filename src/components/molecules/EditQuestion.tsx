...
export const EditQuestion: VFC<Props> = memo(({ question, setQuestion, isNew }) => {
  log.setLevel('debug')
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-start items-center">
          <DocumentTextIcon className="w-6 h-6 ml-8 cursor-pointer hover:text-blue-500"
          ...
          {editCaseNo && (
            <>
              ...
              ></input>
              {edittingCaseNo && <CloudUploadIcon
