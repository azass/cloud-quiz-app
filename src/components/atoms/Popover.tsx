...
function Index() {
  return (
    <>
      ...
      <div
        id="popover"
        className="transition duration-150 ease-in-out -mt-20 absolute top-0 left-0 ml-20 w-full sm:w-1/2"
      >
        <div className="w-full bg-blue-900 rounded shadow-2xl">
          <div className="relative bg-gray-200 rounded-t py-4 px-4 xl:px-8">
            ...
            <p className="text-base text-gray-800 font-normal leading-normal tracking-normal opacity-50">
            ...
            <div className="flex items-stretch mt-2">
              <div className="relative w-full">
                ...
                <input
                  ...
                  defaultValue="https://alphad.co/Q4XY3HWXN95"
                />
                <button className="absolute right-0 top-0 transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none bg-indigo-700 rounded-r text-white px-5 h-10 text-sm">
                  Copy
                </button>
              </div>
            </div>
